...
describe('portability roundtrip', () => {
	...
	async function seedProject() {
		...
		await db.characters.add({
			...
			aliases: ['The Lantern'],
			diasporaOrigin: 'Starward Keep',
			photoUrl: '',
			bio: 'A reckless truth-seeker pulled into the collapse of an old order.',
			faction: 'Starward Keep',
			anomalies: ['Hears signal ghosts in dead radios'],
