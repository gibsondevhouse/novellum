...
| --- | --------------------------------------------------- | -------- | ----------- | ------------- |
| 001 | [Prefill Context](part-001-prefill-context/part.md) | `review` | Codex       | 0.5d          |

## Acceptance Criteria

- [ ] All parts reach `complete` status
- [x] Accepted seeds from brainstorm populate worldbuild context
- [x] Entity generation dialog prefills with seed data
- [x] Prefill data can be edited or cleared
- [x] Component flow tested: brainstorm accept -> worldbuild generation context
