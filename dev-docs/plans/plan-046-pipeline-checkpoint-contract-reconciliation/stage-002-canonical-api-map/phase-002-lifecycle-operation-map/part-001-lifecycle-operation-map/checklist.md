---
part: part-001-lifecycle-operation-map
...
- [x] Lint not run; docs/source-comment/evidence-only operation map
- [x] Type-check not run; docs/source-comment/evidence-only operation map
- [x] Tests not run; docs/source-comment/evidence-only operation map
