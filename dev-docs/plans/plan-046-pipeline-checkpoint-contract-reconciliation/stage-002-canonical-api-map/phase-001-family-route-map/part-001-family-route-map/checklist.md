---
part: part-001-family-route-map
...
- [x] Lint not run; docs/evidence-only route map with no runtime source changes
- [x] Type-check not run; docs/evidence-only route map with no runtime source changes
- [x] Tests not run; docs/evidence-only route map with no runtime source changes
