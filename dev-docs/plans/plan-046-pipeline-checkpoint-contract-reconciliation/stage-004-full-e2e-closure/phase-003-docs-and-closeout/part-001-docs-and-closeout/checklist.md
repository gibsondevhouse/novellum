...
- [x] Type-check passes with zero errors: `pnpm check`
- [x] Tests pass: `pnpm test` and `pnpm test:e2e --project=chromium`
...
- [x] Plan-level reviewer handoff prepared; Reviewer not invoked by implementation agent
