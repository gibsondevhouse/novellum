# part-002 — Scribe Supported Actions
...
Declare supported Scribe actions and route only those actions to task runners.
...
- Outline path supported.
- Unsupported concrete tasks produce bounded response.
