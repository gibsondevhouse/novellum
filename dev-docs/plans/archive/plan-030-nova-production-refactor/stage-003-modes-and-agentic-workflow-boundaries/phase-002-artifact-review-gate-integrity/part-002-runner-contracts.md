...
Ensure author pipeline runner attaches artifacts and surfaces parse/transport failures without applying content.
...
- Runner only attaches artifacts.
- Failure variants are tested.
