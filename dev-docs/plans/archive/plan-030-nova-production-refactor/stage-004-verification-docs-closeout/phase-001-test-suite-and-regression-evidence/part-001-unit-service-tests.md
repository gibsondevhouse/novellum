# part-001 — Unit and Service Tests
...
Run/add service tests for context baseline, no-scene fallback, and generation gates.
...
- Tests fail before fix or directly assert fixed behavior.
- No full manuscript default tested.
