# part-001 — Update Nova Module Doc
...
Document canonical surface, sidepanel states, context disclosure, and mode boundaries.
...
- Known deferred `/nova` route work called out if applicable.
