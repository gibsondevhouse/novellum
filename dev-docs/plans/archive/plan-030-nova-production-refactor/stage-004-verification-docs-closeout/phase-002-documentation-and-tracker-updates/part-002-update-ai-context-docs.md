# part-002 — Update AI Context Docs
...
Document project summary baseline, no-scene fallback, and context scoping rules.
...
- No full manuscript default documented.
- Project baseline described.
