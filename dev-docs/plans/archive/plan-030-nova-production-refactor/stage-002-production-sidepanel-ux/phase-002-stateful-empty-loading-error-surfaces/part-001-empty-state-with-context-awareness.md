# part-001 — Context-Aware Empty State
...
Differentiate project-attached empty state from no-project/general-chat empty state.
...
- Empty copy is truthful.
- Quick prompt only appears when valid.
