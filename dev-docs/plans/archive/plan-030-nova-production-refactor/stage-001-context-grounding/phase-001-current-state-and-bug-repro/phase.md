# phase-001 — Current State and Bug Reproduction
...
Prove and localize the context failure before implementation.
...
- `part-001-map-nova-surfaces.md` — Map Nova Surfaces
- `part-002-reproduce-project-hub-blindness.md` — Reproduce Project Hub Blindness
- `part-003-inventory-context-contracts.md` — Inventory Context Contracts
