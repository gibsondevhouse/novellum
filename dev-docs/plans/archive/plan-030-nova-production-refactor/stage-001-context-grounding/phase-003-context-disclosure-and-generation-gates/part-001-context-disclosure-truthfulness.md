# part-001 — Context Disclosure Truthfulness
...
Update context disclosure state and counts so project/story-frame/outline/compression scopes are visible.
...
- Show `Project attached` or equivalent.
- Show no-context and compressed/truncated states.
