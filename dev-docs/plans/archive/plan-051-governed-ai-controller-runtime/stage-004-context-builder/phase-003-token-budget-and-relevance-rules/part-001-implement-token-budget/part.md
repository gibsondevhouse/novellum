---
title: Implement Token Budget & Relevance Rules
slug: part-001-implement-token-budget
part_number: 1
status: review
owner: Planner Agent
assigned_to: Codex
phase: phase-003-token-budget-and-relevance-rules
estimated_duration: 0.5d
---

## Objective

Implement Token Budget & Relevance Rules for Token Budget & Relevance Rules.
...
**Update:**
- `src/lib/server/ai/controller/context-builder.ts`
