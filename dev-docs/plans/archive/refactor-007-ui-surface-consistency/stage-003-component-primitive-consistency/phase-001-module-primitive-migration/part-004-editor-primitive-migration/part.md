---
title: Editor module primitive migration
slug: part-004-editor-primitive-migration
part_number: 4
status: draft
owner: Planner Agent
...
Replace ad-hoc raw elements in the Editor module with shared Novellum surface and button primitives.
...
- dev-docs/plans/refactor-007-ui-surface-consistency/stage-003-component-primitive-consistency/phase-001-module-primitive-migration/part-004-editor-primitive-migration/evidence/

**Update:**

- src/modules/editor/**; src/lib/components/**; src/routes/**

## Acceptance Criteria

- [ ] Scoped Editor module uses approved primitives for actions and surface wrappers.
