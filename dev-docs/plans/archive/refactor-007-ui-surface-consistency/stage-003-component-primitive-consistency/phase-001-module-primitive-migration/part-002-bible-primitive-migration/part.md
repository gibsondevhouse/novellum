---
title: Bible module primitive migration
slug: part-002-bible-primitive-migration
part_number: 2
status: draft
owner: Planner Agent
...
Replace ad-hoc raw elements in the Bible module with shared Novellum surface and button primitives.
...
- dev-docs/plans/refactor-007-ui-surface-consistency/stage-003-component-primitive-consistency/phase-001-module-primitive-migration/part-002-bible-primitive-migration/evidence/

**Update:**

- src/modules/bible/**; src/lib/components/**; src/routes/**

## Acceptance Criteria

- [ ] Scoped Bible module uses approved primitives for actions and surface wrappers.
