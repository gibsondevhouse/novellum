---
title: Consistency module primitive migration
slug: part-003-consistency-primitive-migration
part_number: 3
status: draft
owner: Planner Agent
...
Replace ad-hoc raw elements in the Consistency module with shared Novellum surface and button primitives.
...
- dev-docs/plans/refactor-007-ui-surface-consistency/stage-003-component-primitive-consistency/phase-001-module-primitive-migration/part-003-consistency-primitive-migration/evidence/

**Update:**

- src/modules/consistency/**; src/lib/components/**; src/routes/**

## Acceptance Criteria

- [ ] Scoped Consistency module uses approved primitives for actions and surface wrappers.
