---
title: Outliner module primitive migration
slug: part-006-outliner-primitive-migration
part_number: 6
status: draft
owner: Planner Agent
...
Replace ad-hoc raw elements in the Outliner module with shared Novellum surface and button primitives.
...
- dev-docs/plans/refactor-007-ui-surface-consistency/stage-003-component-primitive-consistency/phase-001-module-primitive-migration/part-006-outliner-primitive-migration/evidence/

**Update:**

- src/modules/outliner/**; src/lib/components/**; src/routes/**

## Acceptance Criteria

- [ ] Scoped Outliner module uses approved primitives for actions and surface wrappers.
