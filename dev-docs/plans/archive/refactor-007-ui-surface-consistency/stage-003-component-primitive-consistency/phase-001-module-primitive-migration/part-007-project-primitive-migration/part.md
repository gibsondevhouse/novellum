---
title: Project module primitive migration
slug: part-007-project-primitive-migration
part_number: 7
status: draft
owner: Planner Agent
...
Replace ad-hoc raw elements in the Project module with shared Novellum surface and button primitives.
...
- dev-docs/plans/refactor-007-ui-surface-consistency/stage-003-component-primitive-consistency/phase-001-module-primitive-migration/part-007-project-primitive-migration/evidence/

**Update:**

- src/modules/project/**; src/lib/components/**; src/routes/**

## Acceptance Criteria

- [ ] Scoped Project module uses approved primitives for actions and surface wrappers.
