---
title: AI module primitive migration
slug: part-001-ai-primitive-migration
part_number: 1
status: draft
owner: Planner Agent
...
Replace ad-hoc raw elements in the AI module with shared Novellum surface and button primitives.
...
- dev-docs/plans/refactor-007-ui-surface-consistency/stage-003-component-primitive-consistency/phase-001-module-primitive-migration/part-001-ai-primitive-migration/evidence/

**Update:**

- src/modules/ai/**; src/lib/components/**; src/routes/**

## Acceptance Criteria

- [ ] Scoped AI module uses approved primitives for actions and surface wrappers.
