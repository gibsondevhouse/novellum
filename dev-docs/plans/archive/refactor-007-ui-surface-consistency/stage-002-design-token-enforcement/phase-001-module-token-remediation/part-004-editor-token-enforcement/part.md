---
title: Editor module token enforcement
slug: part-004-editor-token-enforcement
part_number: 4
status: draft
owner: Planner Agent
...
Replace hardcoded color, spacing, and border styling in the Editor module with approved design tokens.

## Scope

**In scope:**

- Sweep Editor module Svelte and CSS files for token violations and remediate them
...
- dev-docs/plans/refactor-007-ui-surface-consistency/stage-002-design-token-enforcement/phase-001-module-token-remediation/part-004-editor-token-enforcement/evidence/

**Update:**

- src/modules/editor/**; src/routes/projects/**; src/styles/**

## Acceptance Criteria

- [ ] Scoped Editor module has zero hardcoded token violations in defined grep checks.
