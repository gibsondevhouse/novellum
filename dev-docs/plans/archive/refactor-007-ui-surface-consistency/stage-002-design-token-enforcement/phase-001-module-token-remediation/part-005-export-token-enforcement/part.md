---
title: Export module token enforcement
slug: part-005-export-token-enforcement
part_number: 5
status: draft
owner: Planner Agent
...
Replace hardcoded color, spacing, and border styling in the Export module with approved design tokens.

## Scope

**In scope:**

- Sweep Export module Svelte and CSS files for token violations and remediate them
...
- dev-docs/plans/refactor-007-ui-surface-consistency/stage-002-design-token-enforcement/phase-001-module-token-remediation/part-005-export-token-enforcement/evidence/

**Update:**

- src/modules/export/**; src/routes/projects/**; src/styles/**

## Acceptance Criteria

- [ ] Scoped Export module has zero hardcoded token violations in defined grep checks.
