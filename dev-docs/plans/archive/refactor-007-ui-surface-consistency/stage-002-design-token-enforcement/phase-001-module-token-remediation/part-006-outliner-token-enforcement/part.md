---
title: Outliner module token enforcement
slug: part-006-outliner-token-enforcement
part_number: 6
status: draft
owner: Planner Agent
...
Replace hardcoded color, spacing, and border styling in the Outliner module with approved design tokens.

## Scope

**In scope:**

- Sweep Outliner module Svelte and CSS files for token violations and remediate them
...
- dev-docs/plans/refactor-007-ui-surface-consistency/stage-002-design-token-enforcement/phase-001-module-token-remediation/part-006-outliner-token-enforcement/evidence/

**Update:**

- src/modules/outliner/**; src/routes/projects/**; src/styles/**

## Acceptance Criteria

- [ ] Scoped Outliner module has zero hardcoded token violations in defined grep checks.
