---
title: AI module token enforcement
slug: part-001-ai-token-enforcement
part_number: 1
status: draft
owner: Planner Agent
...
Replace hardcoded color, spacing, and border styling in the AI module with approved design tokens.

## Scope

**In scope:**

- Sweep AI module Svelte and CSS files for token violations and remediate them
...
- dev-docs/plans/refactor-007-ui-surface-consistency/stage-002-design-token-enforcement/phase-001-module-token-remediation/part-001-ai-token-enforcement/evidence/

**Update:**

- src/modules/ai/**; src/routes/projects/**; src/styles/**

## Acceptance Criteria

- [ ] Scoped AI module has zero hardcoded token violations in defined grep checks.
