---
title: Consistency module token enforcement
slug: part-003-consistency-token-enforcement
part_number: 3
status: draft
owner: Planner Agent
...
Replace hardcoded color, spacing, and border styling in the Consistency module with approved design tokens.

## Scope

**In scope:**

- Sweep Consistency module Svelte and CSS files for token violations and remediate them
...
- dev-docs/plans/refactor-007-ui-surface-consistency/stage-002-design-token-enforcement/phase-001-module-token-remediation/part-003-consistency-token-enforcement/evidence/

**Update:**

- src/modules/consistency/**; src/routes/projects/**; src/styles/**

## Acceptance Criteria

- [ ] Scoped Consistency module has zero hardcoded token violations in defined grep checks.
