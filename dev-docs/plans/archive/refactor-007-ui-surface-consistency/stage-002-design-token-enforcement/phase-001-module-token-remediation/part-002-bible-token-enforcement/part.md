---
title: Bible module token enforcement
slug: part-002-bible-token-enforcement
part_number: 2
status: draft
owner: Planner Agent
...
Replace hardcoded color, spacing, and border styling in the Bible module with approved design tokens.

## Scope

**In scope:**

- Sweep Bible module Svelte and CSS files for token violations and remediate them
...
- dev-docs/plans/refactor-007-ui-surface-consistency/stage-002-design-token-enforcement/phase-001-module-token-remediation/part-002-bible-token-enforcement/evidence/

**Update:**

- src/modules/bible/**; src/routes/projects/**; src/styles/**

## Acceptance Criteria

- [ ] Scoped Bible module has zero hardcoded token violations in defined grep checks.
