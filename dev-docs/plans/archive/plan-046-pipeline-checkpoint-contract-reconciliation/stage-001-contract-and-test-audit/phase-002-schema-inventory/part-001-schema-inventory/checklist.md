...
- [x] Lint not run; evidence-only schema inventory with no runtime source changes
- [x] Type-check not run; evidence-only schema inventory with no runtime source changes
- [x] Tests not run; evidence-only schema inventory with no runtime source changes
