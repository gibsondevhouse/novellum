...
- [x] Lint passes with zero errors (9 pre-existing errors in unrelated Svelte components)
- [x] Type-check passes with zero errors (1 pre-existing error in unrelated +page.svelte; 1745 files / 0 new errors)
