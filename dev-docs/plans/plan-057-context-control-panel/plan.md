...
| --- | --- | --- | --- |
| 001 | [Context Selection API Overrides](stage-001-context-metadata-enrichment/stage.md) | `draft` | 2d |
| 002 | [Context Visualization Drawer UI](stage-002-sidebar-context-pill/stage.md) | `draft` | 2d |
| 003 | [Pinning & Exclusion Persistence Store](stage-003-pinning-override-store/stage.md) | `draft` | 1d |
...
- [ ] **tests** — unit coverage of context assembly with overrides
- [ ] **docs_sync** — update [context-engine.md](../../03-ai/context-engine.md)
