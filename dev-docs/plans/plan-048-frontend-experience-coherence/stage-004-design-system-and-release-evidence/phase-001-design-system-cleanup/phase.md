...
parts:
  - part-001-design-system-cleanup
estimated_duration: TBD
---

## Goal

Consolidate repeated frontend patterns into stable components, tokens, and interaction states without broad unrelated redesign.
...
Prefer existing primitives over creating new abstractions unless the duplication is real.
