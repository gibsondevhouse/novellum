# part-002 — Missing Context Guardrails
...
Guard project-dependent generation when project id or core fields are missing.
...
- No-project state before large generation.
- Missing logline/synopsis yields focused request or marked suggestions.
