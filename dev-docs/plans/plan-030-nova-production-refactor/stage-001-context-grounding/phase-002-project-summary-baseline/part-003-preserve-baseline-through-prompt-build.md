# part-003 — Preserve Baseline Through Prompt Build
...
Ensure prompt serialization includes project baseline and truncation does not remove it before lower-priority scopes.
...
- Project title/logline/synopsis appear in prompt context when available.
- Truncation warning is explicit when context is clipped.
