# part-002 — Defer or Migrate Fullscreen Route
...
Either route `/nova` to canonical Nova primitives or mark it deferred with known limitations.
...
- Tests adjusted if route behavior changes.
