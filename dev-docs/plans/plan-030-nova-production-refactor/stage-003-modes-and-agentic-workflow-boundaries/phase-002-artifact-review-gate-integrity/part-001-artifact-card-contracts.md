# part-001 — Artifact Card Contracts
...
Verify artifact cards present accept/reject/copy or review actions without direct editor mutation.
...
- Review actions explicit.
- No editor mutation imports.
