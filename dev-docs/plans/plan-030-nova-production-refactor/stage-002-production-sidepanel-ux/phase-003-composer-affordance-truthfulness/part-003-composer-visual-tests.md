# part-003 — Composer Visual Tests
...
Cover attachment state/disabled state, mode selector, and constrained-width composer layout.
...
- Visual baselines updated or documented.
- No layout clipping.
