# part-003 — Streaming, Aborted, and Error Recovery
...
Make loading, stop, aborted, retry, and transport failure states distinct and recoverable.
...
- Retry does not duplicate user prompts.
- Abort preserves partial content clearly.
