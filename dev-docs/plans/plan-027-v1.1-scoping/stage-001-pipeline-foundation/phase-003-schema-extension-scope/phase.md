...
Decide and implement (if approved) first-class schema support for factions, themes, and glossary terms.
...
This phase is conditional by design: any deferral must still ship explicit fallback mappings.
