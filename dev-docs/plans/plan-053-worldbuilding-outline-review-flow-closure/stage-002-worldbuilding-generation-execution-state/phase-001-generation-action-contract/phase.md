...
| --- | --- | --- | --- | --- |
| 001 | [Replace Nova Prompt Seeding With Generation Action Service](part-001-replace-nova-prompt-seeding-with-generation-action-service/part.md) | `draft` | Codex | 1d |
| 002 | [Add Generation Failure Retry Semantics](part-002-add-generation-failure-retry-semantics/part.md) | `draft` | Codex | 0.5d |

## Acceptance Criteria

- [ ] Actions call real generation endpoints or explicitly block with missing-context copy.
- [ ] The generation state machine is invoked from route actions.
