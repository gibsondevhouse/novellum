...
| --- | --- | --- | --- | --- |
| 001 | [Wire Main Worldbuilding Generate Controls](part-001-wire-main-worldbuilding-generate-controls/part.md) | `draft` | Codex | 0.75d |
| 002 | [Wire Help Route Generate Controls](part-002-wire-help-route-generate-controls/part.md) | `draft` | Codex | 0.75d |

## Acceptance Criteria

- [ ] Both main and help routes use the same generation action service.
- [ ] Status widgets reflect actual domain state.
