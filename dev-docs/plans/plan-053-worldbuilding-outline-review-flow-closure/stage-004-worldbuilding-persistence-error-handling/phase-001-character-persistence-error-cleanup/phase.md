...
| --- | --- | --- | --- | --- |
| 001 | [Route Character Save Errors Through UI State](part-001-route-character-save-errors-through-ui-state/part.md) | `review` | Codex | 1d |

## Acceptance Criteria

- [x] Production route code does not rely on console.error as the only failure surface.
- [x] User-facing save/error state remains intact.
