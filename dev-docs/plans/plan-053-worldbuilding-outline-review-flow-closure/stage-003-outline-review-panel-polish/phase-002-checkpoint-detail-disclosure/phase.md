...
parts:
  - part-001-clean-outline-detail-metadata
  - part-002-add-outline-review-browser-evidence
estimated_duration: 1.25d
---

## Goal

Move raw payloads and runtime internals behind explicit advanced/debug disclosure while keeping reviewer context useful.
