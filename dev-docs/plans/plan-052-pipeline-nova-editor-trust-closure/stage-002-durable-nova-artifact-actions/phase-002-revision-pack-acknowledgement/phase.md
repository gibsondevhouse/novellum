...
| --- | --- | --- | --- | --- |
| 001 | [Persist Revision Acknowledgements](part-001-persist-revision-acknowledgements/part.md) | `draft` | Codex | 1d |
| 002 | [Wire Revision Pack Card To Persistence](part-002-wire-revision-pack-card-to-persistence/part.md) | `draft` | Codex | 0.5d |

## Acceptance Criteria

- [ ] Acknowledged issue IDs reload from persistence.
- [ ] Acknowledge actions are visible in UI state and evidence without mutating manuscript content.
