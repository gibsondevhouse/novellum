...
| --- | ------------------------------------------------------------------------------ | ------- | ------------- |
| 001 | [Type Assertion Cleanup](phase-001-type-assertion-cleanup/phase.md)            | `review` | 0.25d         |
| 002 | [Pre-Merge Verification](phase-002-pre-merge-verification/phase.md)            | `review` | 0.25d         |
