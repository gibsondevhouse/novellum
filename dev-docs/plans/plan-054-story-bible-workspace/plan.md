...
| --- | -------------------------------------------------------------------------------- | ---------- | ------------- |
| 001 | [Database Queries & Repositories](stage-001-wiki-database-queries/stage.md)      | `complete` | 1d            |
| 002 | [Dossier CRUD Forms & Grid](stage-002-dossier-crud-forms/stage.md)               | `complete` | 2d            |
| 003 | [Wiki Hyperlinking & Cross-References](stage-003-navigation-hyperlinks/stage.md) | `complete` | 1d            |
| 004 | [Verification & Quality Gate Closure](stage-004-quality-closure/stage.md)        | `complete` | 1d            |

## Quality Gates

- [x] **lint** — zero ESLint or CSS warnings
- [x] **typecheck** — zero compilation warnings in `pnpm check`
- [x] **tests** — unit coverage of the wiki query service and routing
- [x] **docs_sync** — update `dev-docs/04-modules/story-bible.md`
