...
<section class="dossier-section" aria-label="Voice and Behavior">
	<SectionHeader title="Voice & Behavior" class="dossier-section-header">
		{#snippet actions()}
			<GhostButton type="button" class="collapse-toggle" aria-expanded={!isCollapsed} aria-controls="voice-behavior-content" onclick={() => (isCollapsed = !isCollapsed)}>
