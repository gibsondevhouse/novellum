...
<section class="dossier-section" aria-labelledby="lineage-continuity-title">
	<div class="section-header"><h3 id="lineage-continuity-title" class="section-title">Continuity</h3><button type="button" class="collapse-toggle" aria-expanded={!isCollapsed} aria-controls="lineage-continuity-content" onclick={() => (isCollapsed = !isCollapsed)}>{isCollapsed ? 'Expand' : 'Collapse'}</button></div>
	{#if !isCollapsed}
