<script lang="ts">
	...
	async function handleDelete() {
		...
		goto(`/projects/${data.projectId}/bible/characters`);
	}
</script>
...
<div class="page">
	<div class="page-header">
		<a class="back-link" href="/projects/{data.projectId}/bible/characters">← Characters</a>
	...
	<CharacterForm
		...
		onSave={handleSave}
		onCancel={() => goto(`/projects/${data.projectId}/bible/characters`)}
	/>
