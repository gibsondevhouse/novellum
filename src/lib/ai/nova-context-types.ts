/**
 * Shared Nova context contracts.
 *
 * Defined here (in $lib) so server-side code in $lib/server/nova/ can
 * import them without reaching into $modules. The modules/ai barrel
