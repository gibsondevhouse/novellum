...
const characterDraftSchema = z
	.object({
		...
		coreDesire: trimmedString.optional().default(''),
		fear: trimmedString.optional().default(''),
		contradiction: trimmedString.optional().default(''),
		strength: trimmedString.optional().default(''),
		flaw: trimmedString.optional().default(''),
		storyRole: trimmedString.optional().default(''),
		externalGoal: trimmedString.optional().default(''),
		internalNeed: trimmedString.optional().default(''),
		stakes: trimmedString.optional().default(''),
		voiceSummary: trimmedString.optional().default(''),
		speechPattern: trimmedString.optional().default(''),
